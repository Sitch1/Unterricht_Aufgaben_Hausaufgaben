...
is_winter_holiday = date >= "2024.12.23" and date <= "2025.01.01"  # "2025.01.01"
...
print(is_winter_holiday, is_winter_holiday >= date, date <= is_winter_holiday)
print(type(is_winter_holiday))
